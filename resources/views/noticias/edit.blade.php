        ...
        <div class="container pt-5">
            ...
            <form action="/noticias/{{ $noticia->id }}" method="POST" enctype="multipart/form-data">
                ...
                <div>
                    ...
                    <textarea name="conteudo" rows="5" class="form-control">{{ isset($noticia) ?  isset($noticia)->conteudo : '' }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <div>
                        <img src="{{ isset($noticia)->imagem }}" alt="" height="100px">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="status" class="form-control">
                        <option value="A" {{ isset($noticia)->status == "A" ? 'selected="selected"' : '' }}>Ativo</option>
                        <option value="I" {{ isset($noticia)->status == "I" ? 'selected="selected"' : '' }}>Inativo</option>
                    </select>
                </div>
